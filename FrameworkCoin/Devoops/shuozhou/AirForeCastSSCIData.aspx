<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AirForeCastSSCIData.aspx.cs" Inherits="Devoops_ForeCast_AirForeCastData" %>
                    ...
                    success: function (data) {
                        ...
                        if (arr_data.HasData == 'yes') {
                            for (var i = 0; i < arr_data.Data.length; i++) {
                                strdata += "<tr class=\"thcss\"><td>" + arr_data.Data[i].StationName + "</td><td>" + arr_data.Data[i].MonitorTime.substring(0, 10) + "</td><td>" + arr_data.Data[i].ForecastTime.substring(0, 10)
                                    + "</td><td>" + arr_data.Data[i].SO2 + "</td><td>" + arr_data.Data[i].SO2AQ + "</td>";
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="background: #fff;">
            ...
            <div>
                <b>预测时间：  </b>               
                <input type="text" class="form-control" id="txt_beginDateSec" onclick="WdatePicker({ onpicked: function () { changeCheck(1) } })" />
                <b>至</b>                
                <input type="text" class="form-control" id="txt_endDateSec" onclick="WdatePicker({ onpicked: function () { changeCheck(1) } })" />
