<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AirHourHistData.aspx.cs" Inherits="Devoops_MoniData_AirHourHistData" %>
    ...
    <script>
        ...
        function getData() {
            $.ajax({
                ...
                data: {
                    flag: "tabHour", date: $("#txt_begin").val(), hour: $("#ddl_hour").val()
                },
                dataType: "json",
                success: function (result) {
                    ...
                    if (result && result.DataTable && result.DataTable.length > 0) {
                        ...
                        $('#container').highcharts({
                            ...
                            subtitle: {
                                text: $("#txt_begin").val()+" "+$("#ddl_hour").val()+" 时"
                            },
                            xAxis: {
                        ...
                        $("#tb_report tr:gt(2)").remove();
                        $("#tb_report").append($("<tr style='align:center; ' ><td colspan='18' style='text-align:center; height:40px;'>暂无数据</td></tr>"));
                        $('#container').hide();
                    }
                }
            });
